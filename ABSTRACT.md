...
We present TrialMatchSafe, a safety-aware clinical AI system that reframes trial eligibility screening as a safety-sensitive decision problem. The system separates baseline eligibility determination from a safety-gated decision layer that evaluates whether a decision is safe to act upon. This architecture enables explicit handling of missing information, uncertainty, and clinically relevant exclusion risk that are not reliably captured through simple rule matching.
...
The system provides transparent, criterion-level reasoning and explicitly surfaces uncertainty, enabling more interpretable and clinically aligned outputs. Through this design, TrialMatchSafe demonstrates how clinical AI systems can move beyond performance-focused evaluation toward safety-aware decision support that better reflects real-world clinical workflows.
